...
1 & $\square$ & 10R & METALL 10,0 & 0,05 € & 0,05 \euro \\
6 & $\square$ & 100R & METALL 100 & 0,05 \euro & 0,29 \euro \\
1 & $\square$ & 220R & METALL 220 & 0,05 € & 0,05 \euro \\ 
...
5 & $\square$ & 1N4148 & 1N 4148 & 0,02 \euro & 0,10 \euro \\
...
\multicolumn{4}{|l}{Total\footnote{Prices may change over time.}} & \multicolumn{2}{r|}{\textbf{85,26 \euro}} \\ \hline
\end{longtable}

\subsection{Shave off some \euro\ from the BOM}
The single most expensive item on the BOM is the chasis. You can certainly find some extruded aluminium chassis for less than \EUR{5} on Ebay. You can also get chap rip-offs of the Adafruit SI5351 break-out board for around \EUR{3}, cheap rotary encoders (\EUR{1}) and 2x8 LCD displays (\EUR{3}) there. I shoud announce a competition for the cheapest BOM for this TRX.
