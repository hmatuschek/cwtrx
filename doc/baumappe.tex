...
\includepdf[pages={1,2,4,3,5,6},landscape=true, addtotoc={
 1, section, 1, RX Schaltung, rxscm,
 2, subsection, 1, RX Mischer, rxmix,
 4, subsection, 1, Demodulator, rxdemod,
 3, subsection, 1, NF-Sektion, rxaudio,
...
\includepdf[pages={1,2,3},landscape=true, addtotoc={
 ...
 2, subsection, 1, Unterseite, rxbrdbottom,
 3, subsection, 1, Siebdruck, rxbrdsilk}]{fig/rx_brd.pdf}
\includepdf[landscape=true, addtotoc={
 1, subsection, 1, Bauteil Werte \& Lage, rxval}]{fig/rx_values.pdf}
\includepdf[landscape=true, addtotoc={
 1, section, 1, PA/LP Schaltung, pascm}]{fig/pa_scm.pdf}
\includepdf[pages={1,2,3},landscape=true, addtotoc={
 1, section, 1, PA/LP Board, pabrdtop,
 2, subsection, 1, Unterseite, pabrdbottom,
 3, subsection, 1, Siebdruck, pabrdsilk}]{fig/pa_brd.pdf}
\includepdf[landscape=true, addtotoc={
 1, subsection, 1, Bauteil Werte \& Lage, pacomp}]{fig/pa_values.pdf}
\includepdf[landscape=true, addtotoc={
 1, section, 1, Bohrplan, drillfront}]{fig/drill_front.pdf}
